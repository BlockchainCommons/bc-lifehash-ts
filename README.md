# Blockchain Commons LifeHash

### _by Leonardo Custodio_

**`bc-lifehash-ts`** generates LifeHash visual hashes: deterministic, recognizable images derived from arbitrary data, for spotting fingerprints at a glance.
...
[@blockchaincommons/lifehash](https://www.npmjs.com/package/@blockchaincommons/lifehash) is published to npm. Install it with your package manager of choice:

```sh
npm install @blockchaincommons/lifehash
# or
pnpm add @blockchaincommons/lifehash
# or
yarn add @blockchaincommons/lifehash
# or
bun add @blockchaincommons/lifehash
```
...
|---|---|---|---|
| `"version1"` | 16 × 16 | 32 × 32 | the original HSB hues; kept for images made before the CMYK-friendly gamut existed |
| `"version2"` (default) | 16 × 16 | 32 × 32 | CMYK-friendly |
...
`bc-lifehash-ts` is currently under active development and in beta testing. It should not be used for production tasks until it has had further testing and auditing. See [Blockchain Commons' Development Phases](https://github.com/BlockchainCommons/Community/blob/master/release-path.md).
...
As an open-source, open-development community, Blockchain Commons does not have the resources to provide direct support of our projects. Please consider the discussions area as a locale where you might get answers to questions. Alternatively, please use this repository's [issues](https://github.com/BlockchainCommons/bc-lifehash-ts/issues) feature. Unfortunately, we can not make any promises on response time.
