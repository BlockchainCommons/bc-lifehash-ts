/**
 * Structural properties: the data and digest paths agree, strings are their
 * UTF-8 bytes, module size tiles, alpha appends 255, dimensions follow the version.
 */
import { describe, it, expect } from "vitest";
import fc from "fast-check";
import { createHash } from "node:crypto";
import * as src from "../src";
import { adapterFor, VERSIONS, type VersionName } from "./vectors/recipes";
